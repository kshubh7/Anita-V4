...
global.anitav4 = process.env.BOT_NAME || "JADU7";
global.ownername = process.env.OWNER_NAME || "MR-SHUBHAM";
global.packname = process.env.PACK_NAME || "𝐐𝐔𝐄𝐄𝐍_𝐀𝐍𝐈𝐓𝐀-𝐕𝟒";
global.author = process.env.AUTHOR || "SHUBHAM73";
global.channelname = process.env.CHANNEL_NAME || "Whatsapp Hub";
